    ...
    methods: {
      ...
      async guardarUsuario() {
        try {
          if (this.isEditing) {
            await axios.put(
              `https://api-production-edcf.up.railway.app/${this.usuario.id}`,
              this.usuario
            );
            this.mensaje = "Usuario actualizado exitosamente";
          } else {
            const response = await axios.post(
              "https://api-production-edcf.up.railway.app/",
              this.usuario
            );
      ...
      async eliminarUsuario(id) {
        try {
          await axios.delete(`https://api-production-edcf.up.railway.app/${id}`);
