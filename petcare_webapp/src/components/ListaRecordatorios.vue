...
export default {
  ...
  methods: {
    async obtenerRecordatorios() {
      try {
        const response = await axios.get('https://petcare-fcaze8atc5cpdte0.canadacentral-01.azurewebsites.net/api/recordatorios/1'); // 1 sería el id de la mascota actual
