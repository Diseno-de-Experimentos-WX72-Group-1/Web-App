  ...
  methods: {
    async programarCita() {
      try {
        ...
        const response = await axios.post('https://api-production-edcf.up.railway.app/api/citas/programar', citaConMascota);
    ...
    async cargarDatos() {
      try {
        // Obtener mascotas
        const responseMascotas = await axios.get('https://api-production-edcf.up.railway.app/api/citas/mascotas');
        this.mascotas = responseMascotas.data;

        // Obtener veterinarios con rol de veterinario
        const responseVeterinarios = await axios.get('https://api-production-edcf.up.railway.app/api/citas/usuarios/veterinarios');
