  ...
  methods: {
    async programarCita() {
      try {
        ...
        const response = await axios.post('https://petcare-fcaze8atc5cpdte0.canadacentral-01.azurewebsites.net/api/citas/programar', citaConMascota);
    ...
    async cargarDatos() {
      try {
        // Obtener mascotas
        const responseMascotas = await axios.get('https://petcare-fcaze8atc5cpdte0.canadacentral-01.azurewebsites.net/api/citas/mascotas');
        this.mascotas = responseMascotas.data;

        // Obtener veterinarios con rol de veterinario
        const responseVeterinarios = await axios.get('https://petcare-fcaze8atc5cpdte0.canadacentral-01.azurewebsites.net/api/citas/usuarios/veterinarios');
